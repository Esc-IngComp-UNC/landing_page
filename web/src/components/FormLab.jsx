  ...
  return (
    <motion.div className="formContainer">
      ...
      >
        ...
        <div className="questionBlock">
          <label className="labelForm" htmlFor="texto">
            Quiero Contactar con el laboratorio por qué...:
            <textarea
              name="texto"
              id="texto"
              rows={10}
        ...
        <div className="questionOptionsBlock">
          ...
          {errors.seleccion?.message && (
            <p style={{ color: "red" }}>{errors.seleccion.message}</p>
          )}
        </div>
        <motion.button
          type="submit"
        ...
        {errorDatos && (
          <p style={{ color: "red" }}>Hubo un error al registrar los datos</p>
        )}
      </motion.form>
